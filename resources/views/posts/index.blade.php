...
<div class="flex justify-center">
    <div class=" w-7/12 bg-gray p-4">
        ...
        <div class="mb-4 p-4 bg-white shadow-lg">
            <div class="mb-3">
                <a href="{{route('posts.show', $post)}}" class="font-medium mb-4">{{$post->title}}</a> <span class="text-gray-400 text-sm ml-6 italic">{{$post->user->name}}</span>
            </div>
            ...
            <div class="flex items-center">
                ...
                <a href="{{route('posts.show', $post)}}" class="ml-10"><i class="far fa-comment"></i></a>
